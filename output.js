//Thu Sep 26 2024 02:16:33 GMT+0000 (Coordinated Universal Time)
...
var EC = {
  ...
  "Init": function () {
    ...
    $(".jp-download").click(function () {
      let _0x2b10fc = "<p class=\"cor5 top10\">" + language["21"] + "</p><div class=\"region nav-link textarea bj\"><textarea id=\"bar2\" class=\"cor5\" style=\"width:100%;height:100%\">" + language["22"] + "銆�" + ecData.list[ecData.playid].name + "銆�" + language["23"] + ecData.list[ecData.playid].url + "</textarea></div>\n" + "<button type=\"button\" class=\"button copyBtn\" style=\"width:100%\" data-clipboard-action=\"copy\" data-clipboard-target=\"#bar2\">" + language["24"] + "</button>";
    ...
    const _0x1b6321 = " %c \u77ED\u7459\u55D5\u5BCC\u9898 by \u8349\u6839\xAE %c QQ602524950|906259831\uFF08\u4E25\u7EC2\u4F78\u57C4\u9422\u3124\u5BCC\u68F0\uFFFD\u5BE4\u9E3F\uE195\u6769\uFFFD\u5A09\uFFFD\u7F03\uFFFD\u7AD9\uFF09 ";
  ...
  "Copy": {
    "Init": function () {
      EC.Width < 767 ? ($(".play-score").click(function () {
        EC.Pop.Show($("#rating").prop("outerHTML"), "涓烘湰鐗囪瘎鍒�", function () {});
